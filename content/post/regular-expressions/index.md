...
2. [Basic Regular Expression Patterns](#basic-regular-expression-patterns)
    ...
    5. [Kleene](#kleene)
    6. [Wildcard (.)](#wildcard-)
    7. [Grouping and precedence](#grouping-and-precedence)

<h2 id="what-is-regular-expressions">What is Regular Expressions</h2>What is Regular Expressions</h2>
...
<h3 id="grouping-and-precedence"> Grouping and precedence</h3>
...
<br />
<b>References:</b><br>
<a href="https://web.stanford.edu/~jurafsky/slp3/2.pdf">Speech and Language Processing, Dan Jurafsky</a>